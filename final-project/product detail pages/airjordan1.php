        ...
        <div class="row">
          <div class="col">
            <div class="product-image-container">
              <img class="item-image" src="../images/item imgs/air jordan/airjordan1.jpg">
            </div>
          </div>
          <div class="col">
            <div class="details">
              <h2 class="page-item-name">AIR JORDAN 1 RETRO HIGH OG 'UNC TOE'</h2>
              ...
              <p>The Jordan 1 High OG UNC Toe is taking the sneaker game by storm. Jordan Brand masterfully integrates a unique colorway combo of University Blue, Black, and White on this iconic silhouette.</p>
            </div>
          </div>
        </div>
      </div>
