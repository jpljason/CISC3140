        ...
        <div class="row">
          <div class="col">
            <div class="product-image-container">
              <img class="item-image" src="../images/item imgs/converse/converse1.jpg">
            </div>
          </div>
          <div class="col">
            <div class="details">
              <h2 class="page-item-name">COMME DES GARCONS X CHUCK TAYLOR ALL STAR HIGH 'PLAY'</h2>
