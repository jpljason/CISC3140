        ...
        <div class="row">
          <div class="col">
            <div class="product-image-container">
              <img class="item-image" src="../images/item imgs/reebok/reebok2.jpg">
            </div>
          </div>
          <div class="col">
            <div class="details">
              <h2 class="page-item-name">CLUB C 85 VINTAGE 'CHALK BRUSH BROWN'</h2>
              ...
              <p>The Reebok Club C 85 TV Chalk Glen Green is available in different colorways, including chalk, paper white, and glen green. The upper material of the Club C 85 TV Reebok Chalk Glen Green is leather and a rubber sole sits underfoot.  </p>
            </div>
          </div>
        </div>
      </div>
