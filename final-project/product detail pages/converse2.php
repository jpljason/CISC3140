        ...
        <div class="row">
          <div class="col">
            <div class="product-image-container">
              <img class="item-image" src="../images/item imgs/converse/converse2.jpg">
            </div>
          </div>
          <div class="col">
            <div class="details">
              <h2 class="page-item-name">WMNS CHUCK TAYLOR ALL STAR HIGH 'VALENTINE'S DAY 2023 - VINTAGE WHITE'</h2>
              ...
              <span class="price">$109.99</span> <br>
              ...
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique voluptates sunt corporis in est nostrum qui eos, animi ea ut dolorum aliquid reprehenderit id labore eligendi, quo incidunt dolorem eius?</p>
            </div>
          </div>
        </div>
      </div>
