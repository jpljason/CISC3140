        ...
        <div class="row">
          <div class="col">
            <div class="product-image-container">
              <img class="item-image" src="../images/item imgs/air jordan/airjordan3.jpg">
            </div>
          </div>
          <div class="col">
            <div class="details">
              <h2 class="page-item-name">AIR JORDAN 4 RETRO 'THUNDER' 2023</h2>
              ...
              <p>Jordan Brand brought back this fan favorite colorway that is constructed using premium black nubuck uppers with splashes of Tour Yellow throughout the midsole, lace eyelets, and tongue. Michael Jordan's iconic Jumpman logo is placed on the heel tab, tongue and insoles of the sneakers.</p>
            </div>
          </div>
        </div>
      </div>
